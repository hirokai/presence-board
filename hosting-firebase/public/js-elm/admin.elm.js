...
{
	if (region.cc.aj === region.cs.aj)
	{
		return 'on line ' + region.cc.aj;
	}
	return 'on lines ' + region.cc.aj + ' through ' + region.cs.aj;
}
...
var author$project$Main$init = function (members) {
	return _Utils_Tuple2(
		{
			z: {
				E: elm$core$String$concat(
					A2(
						elm$core$List$map,
						function (m) {
							return m.k + '\n';
...
var author$project$Main$sendChange = _Platform_outgoingPort('sendChange', elm$json$Json$Encode$string);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(
					model,
					author$project$Main$sendChange(model.z.E));
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Main$CancelChange = {$: 2};
var author$project$Main$SaveChange = {$: 1};
var author$project$Main$UpdateMembers = function (a) {
	return {$: 3, a: a};
};
var author$project$Main$places = _List_fromArray(
	['居室', '帰宅', '314', '104', '105', '食事・休憩', '授業', '外出(青葉山)', '外出(その他)', '学会・出張', '帰省・休暇', '不明']);
...
var rundis$elm_bootstrap$Bootstrap$Internal$Button$defaultOptions = {aK: _List_Nil, aM: false, s: elm$core$Maybe$Nothing, aT: false, bD: elm$core$Maybe$Nothing};
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('disabled', options.aT)
					])),
				elm$html$Html$Attributes$disabled(options.aT)
			]),
		_Utils_ap(
			function () {
				var _n0 = A2(elm$core$Maybe$andThen, rundis$elm_bootstrap$Bootstrap$General$Internal$screenSizeOption, options.bD);
				if (!_n0.$) {
					var s = _n0.a;
					return _List_fromArray(
						[
		...
		switch (modifier.$) {
			...
			case 4:
				...
				return _Utils_update(
					options,
					{
						bf: elm$core$Maybe$Just(onInput_)
					});
			case 5:
				...
				return _Utils_update(
					options,
					{
						bO: elm$core$Maybe$Just(validation)
					});
			default:
...
var rundis$elm_bootstrap$Bootstrap$Form$Textarea$defaultOptions = {aK: _List_Nil, aT: false, af: elm$core$Maybe$Nothing, bf: elm$core$Maybe$Nothing, bA: elm$core$Maybe$Nothing, bO: elm$core$Maybe$Nothing, p: elm$core$Maybe$Nothing};
	...
	return _Utils_ap(
		...
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						A2(elm$core$Maybe$map, elm$html$Html$Attributes$id, options.af),
						A2(elm$core$Maybe$map, elm$html$Html$Attributes$rows, options.bA),
						A2(elm$core$Maybe$map, elm$html$Html$Attributes$value, options.p),
						A2(elm$core$Maybe$map, elm$html$Html$Events$onInput, options.bf),
						A2(elm$core$Maybe$map, rundis$elm_bootstrap$Bootstrap$Form$Textarea$validationAttribute, options.bO)
					])),
			options.aK));
};
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width = F2(
	function (screenSize, columnCount) {
		return {co: columnCount, cV: screenSize};
	});
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthClass = function (_n0) {
	var screenSize = _n0.cV;
	var columnCount = _n0.co;
	return elm$html$Html$Attributes$class(
		'col' + (A2(
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultColOptions = {aD: elm$core$Maybe$Nothing, aE: elm$core$Maybe$Nothing, aF: elm$core$Maybe$Nothing, aG: elm$core$Maybe$Nothing, aH: elm$core$Maybe$Nothing, aK: _List_Nil, a6: elm$core$Maybe$Nothing, a7: elm$core$Maybe$Nothing, a8: elm$core$Maybe$Nothing, ba: elm$core$Maybe$Nothing, bb: elm$core$Maybe$Nothing, bi: elm$core$Maybe$Nothing, bj: elm$core$Maybe$Nothing, bk: elm$core$Maybe$Nothing, bl: elm$core$Maybe$Nothing, bm: elm$core$Maybe$Nothing, bo: elm$core$Maybe$Nothing, bp: elm$core$Maybe$Nothing, bq: elm$core$Maybe$Nothing, br: elm$core$Maybe$Nothing, bs: elm$core$Maybe$Nothing, bt: elm$core$Maybe$Nothing, bu: elm$core$Maybe$Nothing, bv: elm$core$Maybe$Nothing, bw: elm$core$Maybe$Nothing, bx: elm$core$Maybe$Nothing, bF: elm$core$Maybe$Nothing, au: elm$core$Maybe$Nothing, av: elm$core$Maybe$Nothing, aw: elm$core$Maybe$Nothing, ax: elm$core$Maybe$Nothing, ay: elm$core$Maybe$Nothing};
		...
		rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthsToAttributes(
			_List_fromArray(
				[
					...
					A2(rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width, 0, 0)) : options.ay,
					options.aw,
					options.av,
					options.au,
					options.ax
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultRowOptions = {aK: _List_Nil, aV: elm$core$Maybe$Nothing, aW: elm$core$Maybe$Nothing, aX: elm$core$Maybe$Nothing, aY: elm$core$Maybe$Nothing, aZ: elm$core$Maybe$Nothing, bJ: elm$core$Maybe$Nothing, bK: elm$core$Maybe$Nothing, bL: elm$core$Maybe$Nothing, bM: elm$core$Maybe$Nothing, bN: elm$core$Maybe$Nothing};
					...
					[
						...
						_List_fromArray(
							[
								...
								rundis$elm_bootstrap$Bootstrap$Grid$col,
								_List_fromArray(
									[rundis$elm_bootstrap$Bootstrap$Grid$Col$md3, rundis$elm_bootstrap$Bootstrap$Grid$Col$xs12]),
								_List_fromArray(
									[
										A2(
										elm$html$Html$div,
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$Attributes$cols(6)
															])),
														rundis$elm_bootstrap$Bootstrap$Form$Textarea$value(model.z.E),
														rundis$elm_bootstrap$Bootstrap$Form$Textarea$onInput(author$project$Main$UpdateMembers)
													])),
												A2(
												elm$html$Html$div,
												_List_fromArray(
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		elm$html$Html$Events$onClick(author$project$Main$SaveChange)
																	]))
															]),
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																...
																rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$CancelChange)
															]),
														_List_fromArray(
															[
																elm$html$Html$text('元に戻す')
															]))
													]))
											])),
										A2(
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cu: fragment, cv: host, cI: path, cL: port_, cP: protocol, cQ: query};
	});
...
var author$project$Main$main = elm$browser$Browser$document(
	{dh: author$project$Main$init, $7: author$project$Main$subscriptions, dq: author$project$Main$update, ds: author$project$Main$view});
						...
						return A2(
							...
							function (name) {
								return elm$json$Json$Decode$succeed(
									{k: name, bg: order, an: place});
							},
							A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string));
					},
					A2(elm$json$Json$Decode$field, 'order', elm$json$Json$Decode$float));
			},
			A2(elm$json$Json$Decode$field, 'place', elm$json$Json$Decode$string))))(0)}});}(this));