...
{
	if (region.cg.an === region.cx.an)
	{
		return 'on line ' + region.cg.an;
	}
	return 'on lines ' + region.cg.an + ' through ' + region.cx.an;
}
...
var author$project$Main$init = function (_n0) {
	...
	return _Utils_Tuple2(
		{af: '吉田', l: members, b9: '西澤研 場所の更新', I: places, J: rundis$elm_bootstrap$Bootstrap$Modal$hidden, cl: '居室'},
		elm$core$Platform$Cmd$none);
};
var author$project$Main$FeedMembers = function (a) {
	return {$: 6, a: a};
};
...
var author$project$Main$feedMembers = _Platform_incomingPort(
	'feedMembers',
						...
						return A2(
							...
							function (name) {
								return elm$json$Json$Decode$succeed(
									{a: name, G: order, m: place});
							},
							A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string));
					},
					A2(elm$json$Json$Decode$field, 'order', elm$json$Json$Decode$float));
			},
			A2(elm$json$Json$Decode$field, 'place', elm$json$Json$Decode$string))));
var author$project$Main$updateMember = _Platform_incomingPort(
	'updateMember',
	A2(
		elm$json$Json$Decode$andThen,
		function (place) {
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$updateMember(author$project$Main$Receive),
				author$project$Main$feedMembers(author$project$Main$FeedMembers)
			]));
};
...
var author$project$Main$updateBackend = _Platform_outgoingPort(
	'updateBackend',
	function ($) {
...
var author$project$Main$updateMemberData = F2(
	function (members, new_data) {
		var _n0 = A2(
			elm_community$list_extra$List$Extra$find,
			function (m) {
				return _Utils_eq(m.a, new_data.a);
			},
			members);
		if (!_n0.$) {
			var mm = _n0.a;
			return A2(
				elm$core$List$map,
				function (m) {
					return _Utils_eq(m.a, new_data.a) ? new_data : m;
				},
				members);
		} else {
			return A2(
...
var author$project$Main$updatePlace = F3(
	function (n, p, model) {
		var f = function (e) {
			return _Utils_eq(n, e.a) ? _Utils_update(
				e,
				{m: p}) : e;
		};
		return _Utils_update(
			model,
			{
				l: A2(elm$core$List$map, f, model.l)
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var member = msg.a;
				var p = msg.b;
				var m = A3(author$project$Main$updatePlace, member.a, p, model);
				return _Utils_Tuple2(
					_Utils_update(
						m,
						{J: rundis$elm_bootstrap$Bootstrap$Modal$hidden}),
			...
			case 0:
				...
				var p = msg.b;
				return _Utils_Tuple2(
					A3(author$project$Main$updatePlace, n, p, model),
					elm$core$Platform$Cmd$none);
			case 2:
				var v = msg.a;
				return _Utils_Tuple2(
			...
			case 4:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{af: n, J: rundis$elm_bootstrap$Bootstrap$Modal$shown}),
					elm$core$Platform$Cmd$none);
			case 5:
				var m = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							l: A2(author$project$Main$updateMemberData, model.l, m)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var ms = msg.a;
...
var author$project$Main$DialogFor = function (a) {
	return {$: 4, a: a};
};
var author$project$Main$getColor = F2(
	function (_n0, place_name) {
		var places = _n0.I;
		var _n1 = A2(
			elm_community$list_extra$List$Extra$find,
			function (p) {
				return _Utils_eq(p.a, place_name);
			},
			places);
		if (!_n1.$) {
			var p = _n1.a;
...
var author$project$Main$CloseModal = {$: 3};
var author$project$Main$ChangeAndClose = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var author$project$Main$NoOp = {$: 7};
var author$project$Main$getMember = F2(
	function (name, model) {
		return A2(
			elm_community$list_extra$List$Extra$find,
			function (m) {
				return _Utils_eq(m.a, name);
			},
			model.l);
	});
...
var author$project$Main$mkEnterBtn = F2(
	function (model, place) {
		return A2(
			elm$html$Html$button,
			_List_fromArray(
				[
					A2(elm$html$Html$Attributes$style, 'background', place.aU),
					...
					'width',
					((place.a === '帰宅') || _Utils_eq(place.a, model.cl)) ? '212px' : '100px'),
					elm$html$Html$Events$onClick(
					function () {
						var _n0 = A2(author$project$Main$getMember, model.af, model);
						if (_n0.$ === 1) {
							return author$project$Main$NoOp;
						} else {
							var m = _n0.a;
							return A2(author$project$Main$ChangeAndClose, m, place.a);
						}
					}())
				]),
			_List_fromArray(
				[
					elm$html$Html$text(place.a)
				]));
	});
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width = F2(
	function (screenSize, columnCount) {
		return {ct: columnCount, cZ: screenSize};
	});
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthClass = function (_n0) {
	var screenSize = _n0.cZ;
	var columnCount = _n0.ct;
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultColOptions = {aG: elm$core$Maybe$Nothing, aH: elm$core$Maybe$Nothing, aI: elm$core$Maybe$Nothing, aJ: elm$core$Maybe$Nothing, aK: elm$core$Maybe$Nothing, aN: _List_Nil, bb: elm$core$Maybe$Nothing, bc: elm$core$Maybe$Nothing, bd: elm$core$Maybe$Nothing, bf: elm$core$Maybe$Nothing, bg: elm$core$Maybe$Nothing, bm: elm$core$Maybe$Nothing, bn: elm$core$Maybe$Nothing, bo: elm$core$Maybe$Nothing, bp: elm$core$Maybe$Nothing, bq: elm$core$Maybe$Nothing, bs: elm$core$Maybe$Nothing, bt: elm$core$Maybe$Nothing, bu: elm$core$Maybe$Nothing, bv: elm$core$Maybe$Nothing, bw: elm$core$Maybe$Nothing, bx: elm$core$Maybe$Nothing, by: elm$core$Maybe$Nothing, bz: elm$core$Maybe$Nothing, bA: elm$core$Maybe$Nothing, bB: elm$core$Maybe$Nothing, bJ: elm$core$Maybe$Nothing, ax: elm$core$Maybe$Nothing, ay: elm$core$Maybe$Nothing, az: elm$core$Maybe$Nothing, aA: elm$core$Maybe$Nothing, aB: elm$core$Maybe$Nothing};
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$colAttributes = function (modifiers) {
	...
	var shouldAddDefaultXs = !elm$core$List$length(
		A2(
			...
			elm$core$Basics$identity,
			_List_fromArray(
				[options.aB, options.az, options.ay, options.ax, options.aA])));
	return _Utils_ap(
		rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthsToAttributes(
			_List_fromArray(
				[
					shouldAddDefaultXs ? elm$core$Maybe$Just(
					A2(rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width, 0, 0)) : options.aB,
					options.az,
					options.ay,
					options.ax,
					options.aA
		...
		_Utils_ap(
			rundis$elm_bootstrap$Bootstrap$Grid$Internal$offsetsToAttributes(
				_List_fromArray(
					[options.bg, options.bd, options.bc, options.bb, options.bf])),
			_Utils_ap(
...
var rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultRowOptions = {aN: _List_Nil, a_: elm$core$Maybe$Nothing, a$: elm$core$Maybe$Nothing, a0: elm$core$Maybe$Nothing, a1: elm$core$Maybe$Nothing, a2: elm$core$Maybe$Nothing, bN: elm$core$Maybe$Nothing, bO: elm$core$Maybe$Nothing, bP: elm$core$Maybe$Nothing, bQ: elm$core$Maybe$Nothing, bR: elm$core$Maybe$Nothing};
...
var rundis$elm_bootstrap$Bootstrap$Modal$config = function (closeMsg) {
	return {
		...
		b8: {bZ: true, ah: true, ap: elm$core$Maybe$Nothing},
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('modal-dialog-centered', options.bZ)
					])),
						...
						_List_fromArray(
							[
								...
								_Utils_ap(
									...
									_Utils_ap(
										rundis$elm_bootstrap$Bootstrap$Modal$modalAttributes(conf.b8),
										conf.b8.ah ? _List_fromArray(
											[
												A2(
												elm$html$Html$Events$on,
										...
										A2(
											...
											_List_fromArray(
												[
													...
													rundis$elm_bootstrap$Bootstrap$Modal$renderBody(conf.da),
													rundis$elm_bootstrap$Bootstrap$Modal$renderFooter(conf.b0)
												])))
									]))
							]))
					]),
...
var rundis$elm_bootstrap$Bootstrap$Modal$withAnimation = F2(
	function (animateMsg, _n0) {
		...
		return _Utils_update(
			conf,
			{
				M: elm$core$Maybe$Just(animateMsg)
			});
	});
	...
	return A2(
		...
		A3(
						...
						[
							...
							_List_fromArray(
								[
									...
									A2(
										elm$core$List$map,
										author$project$Main$mkEnterBtn(model),
										model.I))
								]))
						]))
				]),
			A3(
				...
				_List_fromArray(
					[
						elm$html$Html$text(model.af + 'さん')
					]),
				A2(
												...
												A2(
													...
													function (e) {
														return A2(
															...
															_List_fromArray(
																[
																	A2(elm$html$Html$Attributes$style, 'width', '23%'),
																	A2(elm$html$Html$Attributes$style, 'margin', '5px'),
																	...
																	elm$html$Html$Attributes$style,
																	'background',
																	A2(author$project$Main$getColor, model, e.m)),
																	elm$html$Html$Events$onClick(
																	author$project$Main$DialogFor(e.a))
																]),
															_List_fromArray(
																[
																	A2(
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cz: fragment, cA: host, cN: path, cP: port_, cT: protocol, cU: query};
	});
...
var author$project$Main$main = elm$browser$Browser$document(
	{dl: author$project$Main$init, ds: author$project$Main$subscriptions, du: author$project$Main$update, dw: author$project$Main$view});
