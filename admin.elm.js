...
var author$project$Main$init = function (members) {
	return _Utils_Tuple2(
		{
			data: {
				members: elm$core$String$concat(
					A2(
						elm$core$List$map,
						function (m) {
							return m.name + '\n';
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SaveChange':
				return _Utils_Tuple2(
					model,
					author$project$Main$sendChange(model.data.members));
			case 'CancelChange':
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Main$CancelChange = {$: 'CancelChange'};
var author$project$Main$SaveChange = {$: 'SaveChange'};
var author$project$Main$UpdateMembers = function (a) {
	return {$: 'UpdateMembers', a: a};
};
											...
											[
												...
												_List_fromArray(
													[
														...
														rundis$elm_bootstrap$Bootstrap$Form$Textarea$value(model.data.members),
						...
						return A2(
							...
							function (name) {
								return elm$json$Json$Decode$succeed(
									{name: name, order: order, place: place});
							},
